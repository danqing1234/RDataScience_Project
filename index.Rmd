...
This method considers not only the distance between  home and school but also the quality of high schools. This model takes account of more people鈥檚 choice when location-allocation.
...
![Caption for the picture.](./AMP.png)
...
3) High school鈥檚 score based on student鈥檚 evaluation.
   (https://www.niche.com)
  


![Caption for the picture.](./FUNCTION.png)
...
According to these two maps, It鈥檚 clear that schools are relatively evenly distributed. The area of every region allocated to the same school is also similar.
...
I did not add schools鈥? quality labels to represent quality of schools successfully, it is a another important factor which can reflect why these school locate like this.
...
1)According to result, we can see Attendance Maximum Problem has an excellent ability to assign facilities. Besides, it considers people鈥檚 choice. 
